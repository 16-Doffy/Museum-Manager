...
export default function CreateRoleModal({ isOpen, onClose, onSubmit, isLoading }: CreateRoleModalProps) {
      ...
      <div className="relative z-50 w-full max-w-lg mx-4">
        <div className="rounded-xl border border-border bg-card shadow-lg">
          ...
          <div className="flex items-center justify-between p-6 border-b border-border">
            <div>
              <h2 className="text-xl font-semibold text-foreground">Tạo vai trò mới</h2>
              <p className="text-sm text-muted-foreground mt-1">Nhập thông tin vai trò mới</p>
            </div>
            <button
              onClick={handleClose}
